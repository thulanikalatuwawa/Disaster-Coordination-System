...
// loads report data, apply filters, set report status
public class ViewReportsC {
    ...
    public void initialize() {
        ...
        setUpFilters();  //report filtering values
        fillReportsDbTable();  // loads from the database
        applyFilters(); // applying the filter options

        // Mapping the table columns to report model properties
    ...
    // fetch data from the database abd fill the table for admins
    ...
    // Updating the status of the reports
